...
class HuBERTManager:
    ...
    @staticmethod
    def make_sure_tokenizer_installed(model: str = 'quantifier_V1_hubert_base_ls960_23.pth', repo: str = 'GitMylo/bark-voice-cloning', local_file: str = 'tokenizer_large.pth'):
        install_dir = os.path.join('data', 'models', 'hubert')
        if not os.path.isdir(install_dir):
            os.makedirs(install_dir, exist_ok=True)
